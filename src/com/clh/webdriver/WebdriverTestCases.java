...
public class WebdriverTestCases extends TestCase {
   ...
   @Parameters({ "webdriverHost", "webdriverPort", "browser", "webSite",
         "platform", "isHttps", "version" })
   public void startSession(String webdriverHost, int webdriverPort,
         String browser, String webSite, String platform, boolean isHttps,
   ...
   public void setBrowserCapabilites(DesiredCapabilities capability,
